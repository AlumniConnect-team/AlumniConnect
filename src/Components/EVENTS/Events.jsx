  ...
  if (loading) {
    return (
      <div className="min-h-screen flex justify-center items-center bg-slate-50">
        <div className="text-xl font-semibold text-blue-600 animate-pulse">Loading Events...</div>
      </div>
    );
  }
      ...
      <div className="bg-slate-50 min-h-screen font-sans">
          ...
          <div className="bg-[#1e293b] rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row min-h-112.5">
            ...
            <div className="md:w-1/2 p-10 flex flex-col justify-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-4">
                ...
                <Link to="/login" className="bg-transparent border border-slate-500 hover:bg-slate-800 text-white px-8 py-4 rounded-xl font-bold transition text-center">
                  Login
                </Link>
              </div>
        ...
        <section className="py-20 bg-blue-600 relative overflow-hidden mt-12">
          ...
          <div className="max-w-4xl mx-auto text-center px-6 relative z-10">
            ...
            <Link to="/signup" className="inline-block bg-white text-blue-600 px-10 py-4 rounded-xl font-bold hover:bg-blue-50 transition shadow-xl">
